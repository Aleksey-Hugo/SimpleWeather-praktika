package com.popov.simpleweather.ui.setting_screen
...
import com.popov.simpleweather.App
import com.popov.simpleweather.MainActivity
import com.popov.simpleweather.R
import com.popov.simpleweather.data.PreferencesStorage
import com.popov.simpleweather.data.PreferencesStorage.Companion.LOCATION_TYPE
import com.popov.simpleweather.data.PreferencesStorage.Companion.PRESSURE_MEASUREMENT
import com.popov.simpleweather.data.PreferencesStorage.Companion.TEMP_MEASUREMENT
import com.popov.simpleweather.data.PreferencesStorage.Companion.WIND_MEASUREMENT
import com.popov.simpleweather.data.local.LocalDataSourceImpl
import com.popov.simpleweather.databinding.SettingFragmentBinding
import com.popov.simpleweather.domain_logic.view_entities.weather.PlaceViewItem
import com.popov.simpleweather.other.*
import com.popov.simpleweather.ui.about_screen.AboutFragment
import com.popov.simpleweather.ui.select_place_screen.SelectPlaceFragment
import com.popov.simpleweather.ui.select_place_screen.SelectPlaceFragment.Companion.KEY_REQUEST_PLACE
import com.popov.simpleweather.ui.setting_screen.LocationSettingDialogFragment.LocationType
import com.popov.simpleweather.ui.setting_screen.LocationSettingDialogFragment.LocationType.CERTAIN
import com.popov.simpleweather.ui.setting_screen.LocationSettingDialogFragment.LocationType.CURRENT
import com.popov.simpleweather.ui.setting_screen.LocationSettingDialogFragment.OnLocationTypeChoiceCallback
import com.popov.simpleweather.ui.setting_widget_screen.SettingWidgetFragment
import com.popov.simpleweather.ui.weather_widget.WeatherWidget
